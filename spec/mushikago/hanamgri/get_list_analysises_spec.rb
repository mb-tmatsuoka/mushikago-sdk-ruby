...
describe Mushikago::Hanamgri::GetListAnalysisesRequest do
  shared_examples_for 'a valid request instance for get_list_analysises' do |n, o|
    subject{ Mushikago::Hanamgri::GetListAnalysisesRequest.new(n, o) }
    it{ should be_kind_of(Mushikago::Http::GetRequest) }
    its(:path){ should == "/1/hanamgri/domains/#{n}/analysises" }
